  ...
  return (
    <footer className="bg-[#0a1117] text-white py-16 px-4  relative  ">
      <div className="max-w-[1920px] mx-auto flex flex-col  md:justify-center  ">
        ...
        <div className="w-full flex justify-between items-center mt-6 md:mt-0  md:text-lg ">
          ...
          <div className="md:w-1/3 flex md:justify-end justify-center gap-6 text-sm mb-0 md:mt-0 ">
